...
class HiddenCategoriesRepositoryImpl implements HiddenCategoriesRepository {
  final HiddenCategoriesDao _categoriesDao;

  HiddenCategoriesRepositoryImpl(this._categoriesDao);
  ...
  CategoryEntity _toEntity(HiddenCategoryRow row) {
  ...
  Future<CategoryEntity> createCategory({required String name, required String colorHex}) async {
    ...
    final companion = HiddenCategoriesTableCompanion(
      id: Value(id),
      name: Value(name),
